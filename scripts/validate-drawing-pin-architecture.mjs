...
const sqlTruth = requireSqlTruth("drawings:validate");
...
const checks = [
  {
    ...
    patterns: [
      ...
      /pin_kind nvarchar\(30\) NOT NULL/,
      /pin_status nvarchar\(20\) NOT NULL/,
      /CK_DrawingPin_kind/,
      /CK_DrawingPin_status/,
  ...
  },
  {
    ...
    patterns: [
      ...
      /drawing-pin-focus-indicator/,
      /viewport\.scrollTo\(/,
      /componentReview \? 1\.45 : 1/,
    ],
  ...
  {
    name: "deterministic installation drawing navigation",
    file: path.join(root, "src", "pages", "Installations", "InstallationDetails.jsx"),
    patterns: [/nextParams\.set\("tab", "drawings"\)/, /nextParams\.set\("drawing"/, /nextParams\.set\("page"/, /nextParams\.set\("pin"/],
  },
  {
