...
export async function resolveChecklist(req: any, res: Response) { try { return res.json(await service.resolveChecklistFromDocuments(req.params.caseId,req.user)); } catch (e) { return respondError(res,e,"resolve inspection checklist failed"); } }
