/* De installatielijst en de installatiekaart. Het relatiegroepfilter zelf staat sinds
   17 september 2026 in relationGroups.sql.ts, omdat de formuliermonitor dezelfde tekst
   gebruikt; hier blijft het herexporteren staan zodat bestaande imports werken. */
...
} from "./relationGroups.sql.js";

export { RELATION_GROUP_FILTER_PLACEHOLDER };
