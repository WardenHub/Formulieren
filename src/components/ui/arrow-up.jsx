  ...
  return (
    <div
      ...
      <svg
        ...
        <motion.path animate={controls} initial="normal" d="m5 12 7-7 7 7" variants={PATH_VARIANTS} />
        <motion.path animate={controls} initial="normal" d="M12 19V5" variants={SECOND_PATH_VARIANTS} />
      </svg>
    </div>
  );
});
